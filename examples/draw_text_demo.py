...
# create black image
image = ImageUtils.get_blank_bgr_image((640, 360), (0, 0, 0))
...
ImageUtils.draw_text(image, ["Ag", "BCy"],
                     ...
                     font_scale=font_scale, text_color_bgr=(0, 255, 255), vertical_spacing=vertical_space)
...
ImageUtils.draw_text(image, ["Ag", "==", "BCy"],
                     ...
                     font_scale=font_scale, text_color_bgr=(255, 255, 0), vertical_spacing=vertical_space)
